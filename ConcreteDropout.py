...
class ConcreteDropout(nn.Module):
    ...
    def __init__(self, weight_regularizer=1e-6,
                 dropout_regularizer=1e-5, init_min=0.1,
                 init_max=0.1):
...
class Model(nn.Module):
    def __init__(self, input_size, output_size, hidden_units,
        ...
        self.linear1 = nn.Linear(input_size, hidden_units[0])
        self.linear2 = nn.Linear(hidden_units[0], hidden_units[1])
        self.linear3 = nn.Linear(hidden_units[1], output_size)

        self.linear4_mu = nn.Linear(output_size, 1)
        self.linear4_logvar = nn.Linear(output_size, 1)
